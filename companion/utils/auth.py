...
class CognitoAuthenticator:
    ...
    def __get_jwks(self) -> List[JWK]:
        ...
        request = urllib3.request(
            "GET", f"{self.issuer}/.well-known/jwks.json")
...
class CognitAuthMiddleware(object):
    def __init__(self, get_response):
        self.get_response = get_response

    def __call__(self, request):
        COGNITO_AWS_REGION = 'us-west-1'  # 'eu-central-1'
        COGNITO_USER_POOL = 'us-west-1_9KsiejRc2'
        COGNITO_AUDIENCE = '2pd6me8ne29c25t1iuk8dh3msj'
        auth = CognitoAuthenticator(
            pool_region=COGNITO_AWS_REGION,
